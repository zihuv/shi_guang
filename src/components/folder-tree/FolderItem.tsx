...
import { ChevronRight, Folder as FolderIcon, FolderOpen, Globe, Move, Pencil, Plus, Trash2 } from 'lucide-react'
...
export function FolderItem({
  ...
  }, [canDrag, dragPosition, folder.id, folder.name, folders, hasChildren, onDragPositionChange, uniqueContextId])
